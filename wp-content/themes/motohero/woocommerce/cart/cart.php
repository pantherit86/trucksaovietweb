								...
								<div class="item col-md-1 col-sm-1 col-xs-12">
									<div class="delete-item">
                                        ...
                                        echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
                                            ...
                                            esc_html__( 'Remove this item', 'motohero' ),
                                            esc_attr( $product_id ),
				...
				<div class="woo-cart-coupon">
                    ...
                    <div class="row-item woo-coupon-row">
                        ...
                        <input type="text" name="coupon_code" class="input-text" id="coupon_code" value=""
                            ...
                            <button type="submit" class="button update_cart" name="update_cart" value="<?php esc_attr_e('Update Cart', 'motohero'); ?>">
							<!--<em class="fa-icon"><i class="fa fa-refresh"></i></em> -->
							<?php esc_html_e('Update Cart', 'motohero'); ?></button>
                            </div>
                    </div>
				</div>
				</div>
