    ...
    class Inwave_Team extends Inwave_Shortcode2 {
        ...
        function init_params2() {
            return array(
                ...
                "as_parent" => array('except' => 'inwave_tabs,inwave_tab_item_img'),
                "js_view" => 'VcColumnView',
                "params" => array(
                    array(
                        "type" => "dropdown",
        ...
        function init_shortcode($atts, $content = null) {
            ...
            $matches = array();
            $count = preg_match_all('/\[inwave_member\s+avatar="([^\"]+)"(.*)\]/Usi', $content, $matches);
...
if (class_exists('WPBakeryShortCodesContainer')) {
    class WPBakeryShortCode_Inwave_Member extends WPBakeryShortCodesContainer {
    }
}