...
?>
<div class="wrap">
<h2 class="bt-title"><?php echo __('Extrafields','inwavethemes');?>
<a class="bt-button add-new-h2" href ="<?php echo admin_url('edit.php?post_type=iw_portfolio&page=iwp-add-extra-field'); ?>"><?php echo __("Add New",'inwavethemes');?></a>
<a class="bt-button add-new-h2" href ="javascript:void(0);" onclick="javascript:document.getElementById('extrafields-form').submit();return false;"><?php echo __("Delete",'inwavethemes');?></a>
</h2>
    ...
    <table class="wp-list-table widefat fixed posts">
        <thead>
            <tr>
                ...
                <th scope="col" id="tags" class="manage-column column-tags" style=""><?php echo __('Assign to Category','inwavethemes'); ?></th>
        ...
        <tbody id="the-list">
            ...
            <td><?php
                if (!empty($cates)) {
                    ...
                    echo __('All','inwavethemes');
                }
                ?></td>
            <td><?php echo $value->description; ?></td>
            <td><?php echo ($value->published == 1) ? __('Yes','inwavethemes') : __('No','inwavethemes'); ?></td>
