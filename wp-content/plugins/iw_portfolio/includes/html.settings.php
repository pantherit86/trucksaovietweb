    ...
    <form action="<?php echo admin_url(); ?>admin-post.php" method="post">
        <div class="tab-content">
            <div id="display" class="tab active">
                ...
                <h3 class="header-text"><?php echo __("Voting",'inwavethemes'); ?></h3>
                <div class="control-group">
                    <div class="label"><?php echo __('Enable Vote','inwavethemes'); ?></div>
                    <div class="control">
                        <?php
                        ...
                        echo $utility->selectFieldRender('enable_voting', 'enable_voting', isset($bt_options['enable_voting'])?$bt_options['enable_voting']:1, $select_options, '', '', false);
                        ?>
                    </div>
                    <div style="clear: both"></div>
                </div>
                <div class="control-group">
                    <div class="label"><?php echo __('Allow Guest Vote','inwavethemes'); ?></div>
                    <div class="control">
                        <?php
                        echo $utility->selectFieldRender('allow_guest_vote', 'allow_guest_vote', isset($bt_options['allow_guest_vote'])?$bt_options['allow_guest_vote']:0, $select_options, '', '', false);
                        ?>
                    </div>
                    <div style="clear: both"></div>
                </div>
